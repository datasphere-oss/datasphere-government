...
ALTER TABLE dw_dim.partner_user_source_link_map OWNER TO gpadmin;
...
ALTER TABLE his_ht_sb81.ods_ocrm_sbj_habit OWNER TO gpadmin;
...
ALTER TABLE his_ht_sb81.serv_cust_xsb_avgaset OWNER TO trinity;
...
ALTER TABLE report.neeq_risk_result OWNER TO gpadmin;
...
ALTER TABLE report.neeq_risk_result_bo OWNER TO gpadmin;
...
ALTER TABLE report.neeq_risk_result_flag OWNER TO gpadmin;
...
ALTER TABLE report.net_recomm_open_status OWNER TO gpadmin;
...
ALTER TABLE report.net_recomm_status_result OWNER TO gpadmin;
...
ALTER TABLE report.net_recomm_status_result_his OWNER TO gpadmin;
...
ALTER TABLE report.t_fuel_cards_user OWNER TO gpadmin;
...
ALTER TABLE report.tifstockpool_check_detail OWNER TO gpadmin;
...
ALTER TABLE report.tifstockpool_check_result OWNER TO gpadmin;
...
ALTER TABLE src_ht_hs08_hsasset.ht_clientsignjour OWNER TO gpadmin;
...
ALTER TABLE src_ht_hs08_hsasset.sstaccount OWNER TO gpadmin;
...
ALTER TABLE src_ht_hscif2.lcfxckh OWNER TO gpadmin;
...
ALTER TABLE src_ht_hscif2.lcfxckh_zjb OWNER TO trinity;
...
ALTER TABLE src_ht_risk.tifstockpool OWNER TO trinity;
...
ALTER TABLE src_ht_sb81.serv_pty_cust_conv OWNER TO gpadmin;
...
ALTER TABLE src_ht_sb81.swap_tifstockpool OWNER TO trinity;
...
ALTER TABLE src_ht_zlfin_mobile.t_account_ext_info OWNER TO trinity;
...
ALTER TABLE src_ht_zlfin_mobile.t_account_ext_info_kh OWNER TO trinity;
...
ALTER TABLE src_ht_zlfin_mobile.t_account_info OWNER TO gpadmin;
...
ALTER TABLE src_ht_zlfin_mobile.t_account_info_kh OWNER TO trinity;
...
ALTER TABLE src_ht_zlfin_mobile.tifstockpool OWNER TO trinity;
