...
public class ColumnAnalyze {
		...
		else
		{
			...
			if ( sqlparser.sqlfilename != null )
				...
				impact = new ColumnImpact( sqlparser.sqltext,
						...
						false );
			impact.impactSQL();
			ColumnImpact.TColumn[] columnInfos = impact.getColumnInfos( );
			for ( int i = 0; i < columnInfos.length; i++ )
			{
				ColumnImpact.TColumn column = columnInfos[i];
	...
	{
		args = new String[10];
		args[0] =  "/Users/jiaenqiu/Downloads/0-YunLian/workspace-db/DataLinkage/GeneralSQLParser/datalliance/proc_ht_fundnav";
		args[1] =  "/Users/jiaenqiu/Downloads/0-YunLian/workspace-db/DataLinkage/GeneralSQLParser/datalliance/out";
