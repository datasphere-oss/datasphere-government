 ...
 */
@Embeddable
public class CatalogTreeId implements Serializable {
  /**
   * 상위 Catalog Id
   */
  @Column(name="catalog_ancestor")
  String ancestor;

  /**
   * 하위 Catalog Id
   */
  @Column(name="catalog_descendant")
  String descendant;

  public CatalogTreeId() {
  }

  public CatalogTreeId(String ancestor, String descendant) {
  ...
  public boolean equals(Object o) {
    ...
    CatalogTreeId that = (CatalogTreeId) o;
