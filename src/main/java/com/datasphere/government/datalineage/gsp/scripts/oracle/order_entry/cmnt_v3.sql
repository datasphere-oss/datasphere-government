...
'Contains customers datalliance either entered by an employee or by the customer
...
'Warehouse datalliance unspecific to any industry.';
...
'Non-industry-specific datalliance in various categories.';
...
'Non-industry-specific design, allows selection of NLS-setting-specific datalliance
